...
import { Http, RequestOptions, ResponseType } from '@angular/http';
...
public Upload(file: FormData) {
  ...
  try {
    //  https://bagifree-api.herokuapp.com
    //  http://localhost:3000/
    return this.http.post('https://bagifree-api.herokuapp.com/api/v1/upload',
    file);
  } catch {
    this.messageService.showMessage('error', 'Opps! Something went wrong. Please try again.');
  }
