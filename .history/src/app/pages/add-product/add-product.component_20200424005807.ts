...
export class AddProductComponent implements OnInit {
  ...
  dataURItoBlob(dataURI, fileName) {
    ...
    this.imageCompress.compressFile(dataURI, -2, 50, 50).then((res) => {
      dataURICompressed = res;
      console.log(dataURICompressed);
      console.warn('Size in bytes is now:', this.imageCompress.byteCount(dataURICompressed));
    });
    ...
    bar.then(() => {
      // After the image has been uploaded, assign the image into array.
